	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
                ...
                if ($data_cek['level'] == "Kaur Umum") echo "<option value='Kaur Umur' selected>Kaur Umum</option>";
                else echo "<option value='Kaur Umum'>Kaur Umum</option>";

                if ($data_cek['level'] == "Kaur Perencanaan") echo "<option value='Kaur Perencanaan' selected>Kaur Perencanaan</option>";
                else echo "<option value='Kaur Perencanaan'>Kaur Perencanaan</option>";

                if ($data_cek['level'] == "Kepala Desa") echo "<option value='Kepala Desa' selected>Kepala Desa</option>";
                else echo "<option value='Peratin'>Kepala Desa</option>";
